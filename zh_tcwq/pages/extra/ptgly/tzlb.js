...
Page({
    ...
    reLoad: function() {
        var t, a = this, e = this.data.table_id, s = this.data.status || 1, i = this.data.time || "", n = wx.getStorageSync("sjdsjid"), o = this.data.pagenum, c = this.data.start_time, d = this.data.end_time;
        1 == s && (t = "1,2,3"), 2 == s && (t = "1"), 3 == s && (t = "2"), 4 == s && (t = "3"), 
        console.log(s, t, i, c, d, n, o, e), app.util.request({
