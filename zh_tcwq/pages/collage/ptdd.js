...
Page((_defineProperty(_Page = {
    ...
    xztype: function(t) {
        ...
        console.log(a), 0 == a && (e = ""), 1 == a && (e = "1"), 2 == a && (e = "2"), 3 == a && (e = "3"), 
        4 == a && (e = "4"), 5 == a && (e = "5"), this.setData({
    ...
    location: function(t) {
        var e = t.currentTarget.dataset.lat, a = t.currentTarget.dataset.lng, i = t.currentTarget.dataset.address;
    ...
    kindToggle: function(t) {
        ...
        console.log(e);
        for (var i = 0, s = a.length; i < s; ++i) a[i].open = i == e && !a[i].open;
        this.setData({
            order_list: a
        });
    },
    reLoad: function() {
        var i = this, t = this.data.status || 1, e = this.data.state || "", a = this.data.searchinfo || "", s = wx.getStorageSync("sjdsjid"), n = this.data.pagenum;
        console.log(t, e, s, n, a), app.util.request({
            ...
            success: function(t) {
                ...
                for (var e = 0; e < t.data.length; e++) t.data[e].xf_time = util.ormatDate(t.data[e].xf_time), 
                t.data[e].time = util.ormatDate(t.data[e].time), t.data[e].pay_time = util.ormatDate(t.data[e].pay_time);
                t.data.length < 10 ? i.setData({
                    mygd: !0,
                    jzgd: !0
                }) : i.setData({
                    jzgd: !0,
    ...
    onLoad: function(t) {
        ...
        console.log(a, t);
        var i = util.formatTime(new Date()).substring(0, 10).replace(/\//g, "-");
        console.log(i.toString()), this.setData({
            start: i,
            timestart: i,
            timeend: i,
            ...
            title: "拼团订单"
        }), this.reLoad(), app.setNavigationBarColor(this), app.util.request({
